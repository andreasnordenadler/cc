...
function getDevTrackerPreviewAccount(account: MobileAccountResponse | null, bootstrap: MobileBootstrap): MobileAccountResponse | null {
  ...
  return {
    ...
    profile: {
      displayName: "Review Knight",
      bio: "Fictional preview account",
      imageUrl: null,
      email: "review-knight@example.com",
      lastSignInAt: new Date().toISOString(),
    },
    chessAccounts: {
      lichessUsername: "reviewknight",
      chessComUsername: "reviewknight",
      hasAny: true,
    },
    progress: {
    ...
    activeGroupQuests: [
      {
        ...
        leaderboardRows: [
          { rank: "#1", name: "Rook Scout", provider: "lichess · rookscout", progress: "3/4", verified: "3/4 verified", note: "Joined this Multiplayer Side Quest" },
          { rank: "#2", name: "Review Knight", provider: "lichess · reviewknight", progress: "2/4", verified: "2/4 verified", note: "You" },
        ],
      },
    ],
    officialPublicGroupQuests: [
      ...
      },
      {
        ...
        leaderboardRows: [
          ...
          { rank: "#4", name: "Review Knight", provider: "lichess · reviewknight", progress: "1/2", verified: "1/2 verified", note: "You" },
        ],
      },
      {
    ...
    previousOfficialGroupQuests: [
      {
        ...
        leaderboardRows: [
          { rank: "#1", name: "Review Knight", provider: "lichess · reviewknight", progress: "2/2", verified: "2/2 verified", note: "Gold" },
      ...
      },
      {
        ...
        leaderboardRows: [
          ...
          { rank: "#2", name: "Review Knight", provider: "lichess · reviewknight", progress: "1/2", verified: "1/2 verified", note: "Silver" },
        ...
        quests: [
          {
            ...
            leaderboardRows: [
              ...
              { rank: "#2", name: "Review Knight", provider: "lichess · reviewknight", progress: "1/1", verified: "1/1 verified", note: "Silver" },
        ...
        quests: [
          {
            ...
            leaderboardRows: [
              { rank: "#1", name: "Review Knight", provider: "lichess · reviewknight", progress: "1/1", verified: "1/1 verified", note: "Gold" },
