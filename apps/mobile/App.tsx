  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top", "left", "right"]}>
      ...
      <ScrollView
        ref={scrollViewRef}
        style={styles.screen}
        contentContainerStyle={[styles.content, { paddingBottom: Math.max(insets.bottom + 162, 180) }]}
...
const styles = StyleSheet.create({
  ...
  firstRunSteps: { gap: 9 },
  bottomNavBar: { flexDirection: "row", gap: 5, paddingHorizontal: 7, paddingTop: 5, paddingBottom: 5, borderTopWidth: 1, borderColor: "rgba(245,200,106,.34)", backgroundColor: "rgba(255,247,232,.12)" },
  bottomNavItem: { position: "relative", overflow: "hidden", flex: 1, minHeight: 48, alignItems: "center", justifyContent: "center", gap: 1, paddingVertical: 5, borderRadius: 17, borderWidth: 1, borderColor: "rgba(255,247,232,.06)", backgroundColor: "rgba(255,247,232,.045)" },
  ...
  bottomNavActiveDot: { width: 14, height: 2, borderRadius: 999, backgroundColor: colors.gold, marginTop: 2 },
  bottomNavIconFrame: { width: 25, height: 23, alignItems: "center", justifyContent: "center", transform: [{ translateY: 0 }] },
  bottomNavIconFrameActive: { transform: [{ translateY: -1 }] },
  bottomNavLogoImage: { width: 30, height: 30, borderRadius: 9 },
  bottomNavSideQuestImage: { width: 28, height: 28 },
  bottomNavCoatImage: { width: 25, height: 25 },
  bottomNavText: { color: "#e8dcc3", fontSize: 9, fontWeight: "900" },
