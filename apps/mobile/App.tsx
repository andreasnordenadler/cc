...
const styles = StyleSheet.create({
  ...
  homeHeroCard: { overflow: "hidden", gap: 16, marginHorizontal: -14, paddingHorizontal: 20, paddingVertical: 20, borderRadius: 0, borderTopWidth: 1, borderBottomWidth: 1, borderColor: "rgba(245,200,106,.32)", backgroundColor: "rgba(255,247,232,.055)" },
  ...
  whereBeginCard: { gap: 13, marginHorizontal: -14, paddingHorizontal: 20, paddingVertical: 16, borderRadius: 0, borderTopWidth: 1, borderBottomWidth: 1, borderColor: "rgba(255,247,232,.13)", backgroundColor: "rgba(245,200,106,.12)" },
  ...
  groupquestsHero: { gap: 12, marginHorizontal: -14, paddingHorizontal: 20, paddingVertical: 20, borderRadius: 0, borderTopWidth: 1, borderBottomWidth: 1, borderColor: "rgba(245,200,106,.32)", backgroundColor: "rgba(255,247,232,.055)" },
  ...
  websiteRitualCard: { gap: 12, marginHorizontal: -14, paddingHorizontal: 20, paddingVertical: 16, borderRadius: 0, borderTopWidth: 1, borderBottomWidth: 1, borderColor: "rgba(255,247,232,.13)", backgroundColor: "rgba(245,200,106,.12)" },
  ...
  accountAuthCopyCard: { overflow: "hidden", gap: 16, marginHorizontal: -14, paddingHorizontal: 20, paddingVertical: 20, borderRadius: 0, borderTopWidth: 1, borderBottomWidth: 1, borderColor: "rgba(245,200,106,.32)", backgroundColor: "rgba(255,247,232,.055)" },
  ...
  accountAuthFormCard: { gap: 12, marginHorizontal: -14, paddingHorizontal: 20, paddingVertical: 18, borderRadius: 0, borderTopWidth: 1, borderBottomWidth: 1, borderColor: "rgba(255,247,232,.13)", backgroundColor: "rgba(255,247,232,.055)" },
  currentMissionCard: { gap: 16, marginHorizontal: -14, paddingHorizontal: 20, paddingVertical: 18, borderRadius: 0, borderTopWidth: 1, borderBottomWidth: 1, borderColor: "rgba(245,200,106,.32)", backgroundColor: "rgba(255,247,232,.055)" },
  ...
  questLogCollectionCard: { gap: 13, marginHorizontal: -14, paddingHorizontal: 20, paddingVertical: 16, borderRadius: 0, borderTopWidth: 1, borderBottomWidth: 1, borderColor: "rgba(255,247,232,.13)", backgroundColor: "rgba(245,200,106,.12)" },
