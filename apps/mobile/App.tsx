...
const compactStyles = StyleSheet.create({
  ...
  coatHeroMarker: { width: 236, height: 236, alignItems: "center", justifyContent: "center", overflow: "visible", borderRadius: 34, borderWidth: 1, borderColor: "rgba(245,200,106,.34)", backgroundColor: "rgba(8,7,10,.42)", shadowColor: colors.gold, shadowOpacity: .22, shadowRadius: 18, elevation: 4 },
  ...
  currentQuestHeroTitle: { maxWidth: 286, color: colors.paper, fontSize: 20, lineHeight: 23, fontWeight: "900", letterSpacing: -.55, textAlign: "center", marginTop: -2 },
