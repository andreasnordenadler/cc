...
const styles = StyleSheet.create({
  ...
  webTopNavInner: { alignItems: "center", gap: 7, paddingHorizontal: 12, paddingVertical: 10 },
  webBrandPill: { position: "relative", alignItems: "center", justifyContent: "center", width: 72, height: 40, marginRight: 4, borderRadius: 999, backgroundColor: "transparent", shadowColor: "#fff", shadowOpacity: 0.26, shadowRadius: 18 },
  webBrandLogo: { width: 66, height: 36 },
  webNavPill: { alignItems: "center", justifyContent: "center", paddingHorizontal: 10, paddingVertical: 8, borderRadius: 999, borderWidth: 1, borderColor: "transparent", backgroundColor: "rgba(255,255,255,.06)" },
  webNavPillActive: { borderColor: "rgba(245,200,106,.24)", backgroundColor: "rgba(245,200,106,.14)" },
  webNavPillText: { color: colors.muted, fontSize: 12, fontWeight: "900" },
  webNavPillTextActive: { color: colors.gold },
  homeHeroCard: { overflow: "hidden", gap: 16, padding: 21, borderRadius: 30, borderWidth: 1, borderColor: "rgba(255,255,255,.14)", backgroundColor: "rgba(255,255,255,.075)", shadowColor: "#000", shadowOpacity: 0.25, shadowRadius: 34, shadowOffset: { width: 0, height: 18 }, elevation: 6 },
  homeHeroGoldGlow: { position: "absolute", right: -92, top: -66, width: 180, height: 180, borderRadius: 90, backgroundColor: "rgba(245,200,106,.13)" },
  homeHeroPinkGlow: { position: "absolute", left: -102, bottom: -112, width: 190, height: 190, borderRadius: 95, backgroundColor: "rgba(255,95,159,.1)" },
  homeHeroTitle: { color: colors.paper, fontSize: 40, fontWeight: "900", letterSpacing: -2.6, lineHeight: 37 },
  ...
  websiteRitualCard: { gap: 12, padding: 16, borderRadius: 26, borderWidth: 1, borderColor: "rgba(255,247,232,.13)", backgroundColor: "rgba(245,200,106,.14)" },
  ...
  firstRunSteps: { gap: 9 },
  bottomNavBar: { flexDirection: "row", gap: 5, paddingHorizontal: 8, paddingTop: 6, paddingBottom: 6, borderTopLeftRadius: 22, borderTopRightRadius: 22, borderTopWidth: 1, borderColor: "rgba(245,200,106,.26)", backgroundColor: "rgba(23,17,25,.96)" },
  bottomNavItem: { position: "relative", overflow: "hidden", flex: 1, minHeight: 50, alignItems: "center", justifyContent: "center", gap: 2, paddingVertical: 6, borderRadius: 18, borderWidth: 1, borderColor: "transparent" },
  ...
  bottomNavIconFrame: { width: 26, height: 24, alignItems: "center", justifyContent: "center", transform: [{ translateY: 0 }] },
  bottomNavIconFrameActive: { transform: [{ translateY: -1 }] },
  bottomNavLogoImage: { width: 23, height: 23, borderRadius: 7 },
  bottomNavCoatImage: { width: 25, height: 25 },
  ...
  accountStatusStrip: { gap: 7, padding: 12, borderRadius: 18, borderWidth: 1, borderColor: "rgba(255,247,232,.1)", backgroundColor: "rgba(0,0,0,.18)" },
  ...
  currentMissionCoat: { width: "100%", gap: 10, alignItems: "center", padding: 15, borderRadius: 24, borderWidth: 1, borderColor: "rgba(245,200,106,.24)", backgroundColor: "rgba(0,0,0,.2)" },
  ...
  questLogCollectionCard: { gap: 13, padding: 16, borderRadius: 26, borderWidth: 1, borderColor: "rgba(255,247,232,.13)", backgroundColor: "rgba(245,200,106,.14)" },
  ...
  bigScore: { flex: 1, alignItems: "center", gap: 2, padding: 12, borderRadius: 18, backgroundColor: "rgba(0,0,0,.22)" },
  ...
  accountChecklistCard: { gap: 12, padding: 16, borderRadius: 24, backgroundColor: "rgba(255,247,232,.08)", borderWidth: 1, borderColor: "rgba(255,247,232,.13)" },
  ...
  checkerFlow: { gap: 10 },
  flowStep: { flexDirection: "row", gap: 10, padding: 13, borderRadius: 18, backgroundColor: "rgba(0,0,0,.18)", borderWidth: 1, borderColor: "rgba(255,247,232,.08)" },
