...
const colors = {
  ...
  green: "#60f0af",
  red: "#ff7a66",
  panel: "rgba(20,13,13,.06)",
  panelStrong: "rgba(20,13,13,.09)",
  stroke: "rgba(20,13,13,.12)",
};

const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: "#fff7e8" },
  ...
  scrollHintPill: { position: "absolute", right: 18, width: 42, height: 30, alignItems: "center", justifyContent: "center", borderRadius: 999, borderWidth: 1, borderColor: "rgba(245,200,106,.38)", backgroundColor: "rgba(255,250,240,.94)", shadowColor: "#000", shadowOpacity: 0.34, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 7 },
  screenStack: { gap: 14 },
  heroCard: {
    overflow: "hidden",
    gap: 14,
  ...
  homeHeroCard: { overflow: "hidden", gap: 16, padding: 20, borderRadius: 30, borderWidth: 1, borderColor: "rgba(245,200,106,.32)", backgroundColor: "#fff7e8" },
  ...
  whereBeginCard: { gap: 13, padding: 16, borderRadius: 26, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(245,200,106,.14)" },
  heroismChoiceList: { gap: 10 },
  heroismChoiceCard: { flexDirection: "row", alignItems: "center", gap: 12, padding: 12, borderRadius: 20, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(82,38,15,.065)" },
  heroismBadgeFrame: { width: 58, height: 66, alignItems: "center", justifyContent: "center", borderRadius: 18, backgroundColor: "rgba(82,38,15,.08)", borderWidth: 1, borderColor: "rgba(245,200,106,.2)" },
  ...
  sideQuestHubHero: { gap: 12, padding: 20, borderRadius: 30, borderWidth: 1, borderColor: "rgba(245,200,106,.32)", backgroundColor: "#fff7e8" },
  ...
  sideQuestModeCard: { gap: 11, padding: 16, borderRadius: 24, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(20,13,13,.06)" },
  groupModeCard: { borderColor: "rgba(245,200,106,.24)", backgroundColor: "rgba(245,200,106,.08)" },
  groupquestsHero: { gap: 12, padding: 20, borderRadius: 30, borderWidth: 1, borderColor: "rgba(245,200,106,.32)", backgroundColor: "#fff7e8" },
  ...
  groupquestsStoryCard: { gap: 16, padding: 16, borderRadius: 24, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(20,13,13,.06)" },
  groupquestsStoryCopy: { gap: 10 },
  groupquestsProcessGraphic: { alignItems: "center", justifyContent: "center", borderRadius: 24, backgroundColor: "rgba(82,38,15,.06)", overflow: "hidden" },
  groupquestsKnightArt: { width: "100%", height: 230 },
  groupquestsLoggedOutActions: { gap: 12 },
  groupquestsActionCard: { gap: 11, padding: 16, borderRadius: 24, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(20,13,13,.06)" },
  groupquestsHowCard: { gap: 14, padding: 16, borderRadius: 24, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(20,13,13,.06)" },
  groupquestsHowGrid: { gap: 10 },
  groupquestsHowStep: { gap: 5, padding: 13, borderRadius: 18, borderWidth: 1, borderColor: "rgba(20,13,13,.09)", backgroundColor: "rgba(82,38,15,.065)" },
  ...
  questFilterPanel: { gap: 14, padding: 16, borderRadius: 24, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(20,13,13,.06)" },
  ...
  filterValue: { color: colors.paper, fontSize: 15, fontWeight: "900", paddingHorizontal: 12, paddingVertical: 11, borderRadius: 14, borderWidth: 1, borderColor: "rgba(20,13,13,.14)", backgroundColor: "rgba(82,38,15,.075)" },
  filterResetButton: { alignSelf: "flex-start", paddingHorizontal: 14, paddingVertical: 11, borderRadius: 999, borderWidth: 1, borderColor: "rgba(20,13,13,.18)", opacity: 0.62 },
  filterResetText: { color: colors.muted, fontWeight: "900" },
  availableQuestGrid: { gap: 12 },
  sideQuestSection: { gap: 13, padding: 16, borderRadius: 24, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(20,13,13,.06)" },
  sectionHeadMobile: { gap: 6 },
  challengeCardMobile: { gap: 13, padding: 15, borderRadius: 24, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(20,13,13,.06)" },
  ...
  difficultyBadgeMobile: { overflow: "hidden", color: colors.paper, fontSize: 11, fontWeight: "900", textTransform: "uppercase", paddingHorizontal: 8, paddingVertical: 4, borderRadius: 999, backgroundColor: "rgba(20,13,13,.09)" },
  ...
  difficultyHard: { backgroundColor: "rgba(255,160,92,.18)", color: "#9a4b00" },
  difficultyBrutal: { backgroundColor: "rgba(255,122,102,.18)", color: colors.red },
  difficultyAbsurd: { backgroundColor: "rgba(255,95,159,.2)", color: "#9b245c" },
  ...
  badgesHeroCard: { gap: 18, padding: 20, borderRadius: 30, borderWidth: 1, borderColor: "rgba(245,200,106,.32)", backgroundColor: "#fff7e8" },
  ...
  badgeMeaningCard: { flexDirection: "row", gap: 14, padding: 15, borderRadius: 24, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(20,13,13,.06)" },
  ...
  websiteRitualCard: { gap: 12, padding: 16, borderRadius: 26, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(245,200,106,.14)" },
  ...
  heroBadgeFrame: { width: 88, height: 104, alignItems: "center", justifyContent: "center", borderRadius: 26, borderWidth: 1, borderColor: "rgba(245,200,106,.24)", backgroundColor: "rgba(82,38,15,.1)" },
  heroBadgeFrameCompact: { width: 68, height: 78, alignItems: "center", justifyContent: "center", borderRadius: 22, borderWidth: 1, borderColor: "rgba(245,200,106,.24)", backgroundColor: "rgba(82,38,15,.1)" },
  ...
  miniStat: { flex: 1, gap: 3, padding: 10, borderRadius: 16, backgroundColor: "rgba(82,38,15,.1)", borderWidth: 1, borderColor: "rgba(20,13,13,.065)" },
  ...
  offlineIcon: { width: 36, height: 36, textAlign: "center", textAlignVertical: "center", borderRadius: 18, overflow: "hidden", color: colors.green, fontSize: 22, backgroundColor: "rgba(82,38,15,.08)" },
  ...
  errorCopy: { color: "#8f2f20", lineHeight: 20 },
  ...
  secondaryButton: { alignSelf: "flex-start", paddingHorizontal: 14, paddingVertical: 11, borderRadius: 999, borderWidth: 1, borderColor: "rgba(20,13,13,.18)", backgroundColor: "rgba(20,13,13,.065)" },
  secondaryButtonWide: { alignItems: "center", justifyContent: "center", paddingHorizontal: 14, paddingVertical: 12, borderRadius: 999, borderWidth: 1, borderColor: "rgba(20,13,13,.18)", backgroundColor: "rgba(20,13,13,.065)" },
  secondaryButtonText: { color: colors.paper, fontWeight: "900" },
  quickStartCard: { gap: 13, padding: 16, borderRadius: 24, borderWidth: 1, borderColor: "rgba(245,200,106,.34)", backgroundColor: "rgba(20,13,13,.065)" },
  ...
  quickScoreRail: { width: 76, gap: 2, alignItems: "center", justifyContent: "center", padding: 10, borderRadius: 20, backgroundColor: "rgba(82,38,15,.08)", borderWidth: 1, borderColor: "rgba(245,200,106,.18)" },
  ...
  questFlowStrip: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 6, padding: 10, borderRadius: 16, backgroundColor: "rgba(82,38,15,.065)", borderWidth: 1, borderColor: "rgba(20,13,13,.065)" },
  ...
  accountModeStrip: { flexDirection: "row", alignItems: "center", gap: 8, padding: 10, borderRadius: 16, backgroundColor: "rgba(82,38,15,.075)", borderWidth: 1, borderColor: "rgba(96,240,175,.18)" },
  ...
  parityRouteButton: { flexDirection: "row", alignItems: "center", gap: 11, padding: 12, borderRadius: 18, borderWidth: 1, borderColor: "rgba(20,13,13,.09)", backgroundColor: "rgba(82,38,15,.075)" },
  parityRouteIcon: { width: 34, height: 34, textAlign: "center", textAlignVertical: "center", borderRadius: 17, overflow: "hidden", color: colors.gold, fontSize: 20, backgroundColor: "rgba(20,13,13,.065)" },
  ...
  paritySafetyStrip: { flexDirection: "row", gap: 10, alignItems: "center", padding: 12, borderRadius: 18, backgroundColor: "rgba(82,38,15,.065)", borderWidth: 1, borderColor: "rgba(96,240,175,.18)" },
  firstRunCard: { gap: 12, padding: 16, borderRadius: 24, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(245,200,106,.14)" },
  firstRunTitle: { color: colors.paper, fontSize: 21, fontWeight: "900", letterSpacing: -0.8 },
  firstRunSteps: { gap: 9 },
  bottomNavBar: { flexDirection: "row", gap: 6, paddingHorizontal: 10, paddingTop: 8, paddingBottom: 8, borderTopLeftRadius: 24, borderTopRightRadius: 24, borderTopWidth: 1, borderColor: "rgba(245,200,106,.26)", backgroundColor: "#fff7e8" },
  ...
  tabPill: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 13, paddingVertical: 9, borderRadius: 999, borderWidth: 1, borderColor: colors.stroke, backgroundColor: "rgba(20,13,13,.055)" },
  ...
  questNumberPill: { width: 34, height: 34, alignItems: "center", justifyContent: "center", borderRadius: 17, backgroundColor: "rgba(82,38,15,.12)" },
  ...
  rarityPill: { overflow: "hidden", alignSelf: "flex-start", color: colors.paper, fontSize: 10, fontWeight: "900", textTransform: "uppercase", paddingHorizontal: 8, paddingVertical: 4, borderRadius: 999, backgroundColor: "rgba(20,13,13,.09)" },
  ...
  badgeImageFrame: { width: 112, height: 128, alignItems: "center", justifyContent: "center", borderRadius: 30, backgroundColor: "rgba(82,38,15,.065)", borderWidth: 1, borderColor: "rgba(245,200,106,.22)" },
  badgeImage: { width: 104, height: 120 },
  badgeFallbackText: { color: colors.gold, fontSize: 34, fontWeight: "900" },
  questFlavorCard: { padding: 14, borderRadius: 20, backgroundColor: "rgba(82,38,15,.075)", borderWidth: 1, borderColor: "rgba(20,13,13,.065)" },
  ...
  factGrid: { gap: 8 },
  fact: { gap: 4, padding: 12, borderRadius: 18, backgroundColor: "rgba(82,38,15,.075)", borderWidth: 1, borderColor: "rgba(20,13,13,.06)" },
  ...
  accountAuthCopyCard: { gap: 16, padding: 20, borderRadius: 30, borderWidth: 1, borderColor: "rgba(245,200,106,.32)", backgroundColor: "#fff7e8" },
  ...
  authLightweightCopy: { gap: 10, padding: 14, borderRadius: 22, borderWidth: 1, borderColor: "rgba(20,13,13,.1)", backgroundColor: "rgba(20,13,13,.055)" },
  authNote: { color: colors.muted, fontSize: 13, lineHeight: 19 },
  authNoteStrong: { color: colors.paper, fontWeight: "900" },
  accountAuthFormCard: { gap: 12, padding: 18, borderRadius: 28, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(20,13,13,.06)" },
  currentMissionCard: { gap: 16, padding: 18, borderRadius: 30, borderWidth: 1, borderColor: "rgba(245,200,106,.32)", backgroundColor: "#fff7e8" },
  ...
  accountStatusStrip: { gap: 7, padding: 12, borderRadius: 18, borderWidth: 1, borderColor: "rgba(20,13,13,.09)", backgroundColor: "rgba(82,38,15,.065)" },
  ...
  currentMissionTitle: { color: colors.paper, fontSize: 25, fontWeight: "900", letterSpacing: -1, lineHeight: 28 },
  currentMissionBody: { color: colors.muted, fontSize: 15, lineHeight: 22 },
  currentMissionMultiplayer: { gap: 10, padding: 13, borderRadius: 20, borderWidth: 1, borderColor: "rgba(96,240,175,.2)", backgroundColor: "rgba(96,240,175,.07)" },
  activeMultiplayerRow: { flexDirection: "row", gap: 10, alignItems: "center", padding: 10, borderRadius: 16, borderWidth: 1, borderColor: "rgba(20,13,13,.09)", backgroundColor: "rgba(82,38,15,.065)" },
  ...
  currentMissionCoat: { width: "100%", gap: 10, alignItems: "center", padding: 15, borderRadius: 24, borderWidth: 1, borderColor: "rgba(245,200,106,.24)", backgroundColor: "rgba(82,38,15,.075)" },
  currentMissionCoatImage: { width: 150, height: 168 },
  currentMissionCoatLabel: { color: colors.paper, fontSize: 15, fontWeight: "900", textAlign: "center" },
  currentMissionEmpty: { width: "100%", gap: 10, alignItems: "center", padding: 18, borderRadius: 24, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(82,38,15,.065)" },
  currentMissionEmptyBadge: { width: 72, height: 72, textAlign: "center", textAlignVertical: "center", borderRadius: 36, overflow: "hidden", color: colors.gold, fontSize: 38, fontWeight: "900", backgroundColor: "rgba(20,13,13,.065)" },
  questLogCollectionCard: { gap: 13, padding: 16, borderRadius: 26, borderWidth: 1, borderColor: "rgba(20,13,13,.12)", backgroundColor: "rgba(245,200,106,.14)" },
  ...
  bigScore: { flex: 1, alignItems: "center", gap: 2, padding: 12, borderRadius: 18, backgroundColor: "rgba(82,38,15,.08)" },
  ...
  noticeStrip: { flexDirection: "row", gap: 10, alignItems: "center", padding: 12, borderRadius: 18, backgroundColor: "rgba(82,38,15,.065)", borderWidth: 1, borderColor: "rgba(20,13,13,.065)" },
  ...
  requirementPill: { flex: 1, gap: 4, padding: 12, borderRadius: 18, backgroundColor: "rgba(82,38,15,.075)", borderWidth: 1, borderColor: "rgba(245,200,106,.16)" },
  ...
  accountChecklistCard: { gap: 12, padding: 16, borderRadius: 24, backgroundColor: "rgba(20,13,13,.065)", borderWidth: 1, borderColor: "rgba(20,13,13,.12)" },
  ...
  heraldryGlyph: { width: 46, height: 46, textAlign: "center", textAlignVertical: "center", color: colors.gold, fontSize: 26, fontWeight: "900", borderRadius: 23, backgroundColor: "rgba(82,38,15,.09)", overflow: "hidden" },
  ...
  progressCard: { gap: 9, padding: 14, borderRadius: 20, backgroundColor: "rgba(82,38,15,.065)", borderWidth: 1, borderColor: "rgba(96,240,175,.2)" },
  ...
  progressTrack: { overflow: "hidden", height: 10, borderRadius: 999, backgroundColor: "rgba(20,13,13,.075)" },
  ...
  textInput: { color: colors.paper, paddingHorizontal: 13, paddingVertical: 11, borderRadius: 16, borderWidth: 1, borderColor: "rgba(20,13,13,.14)", backgroundColor: "rgba(82,38,15,.08)", fontSize: 15, fontWeight: "800" },
  ...
  momentumIcon: { width: 38, height: 38, textAlign: "center", textAlignVertical: "center", borderRadius: 19, overflow: "hidden", fontSize: 22, backgroundColor: "rgba(82,38,15,.075)" },
  ...
  trophyBadge: { width: 46, height: 52, alignItems: "center", justifyContent: "center", borderRadius: 16, backgroundColor: "rgba(82,38,15,.08)" },
  ...
  checkerFlow: { gap: 10 },
  flowStep: { flexDirection: "row", gap: 10, padding: 13, borderRadius: 18, backgroundColor: "rgba(82,38,15,.065)", borderWidth: 1, borderColor: "rgba(20,13,13,.065)" },
  ...
  confidenceCard: { flexDirection: "row", gap: 12, alignItems: "center", padding: 14, borderRadius: 20, backgroundColor: "rgba(20,13,13,.06)", borderWidth: 1, borderColor: "rgba(20,13,13,.12)" },
  confidenceIcon: { width: 40, height: 40, textAlign: "center", textAlignVertical: "center", borderRadius: 20, overflow: "hidden", fontSize: 22, backgroundColor: "rgba(82,38,15,.08)" },
  ...
  coatHeroFrame: { alignSelf: "center", width: 188, height: 212, alignItems: "center", justifyContent: "center", borderRadius: 42, borderWidth: 1, borderColor: "rgba(245,200,106,.34)", backgroundColor: "rgba(82,38,15,.09)", shadowColor: colors.gold, shadowOpacity: 0.24, shadowRadius: 18, elevation: 4 },
  coatHeroImage: { width: 170, height: 194 },
  proofPreviewBadgeFrame: { alignSelf: "center", width: 138, height: 154, alignItems: "center", justifyContent: "center", borderRadius: 34, borderWidth: 1, borderColor: "rgba(245,200,106,.24)", backgroundColor: "rgba(82,38,15,.075)" },
  ...
  lockedPill: { overflow: "hidden", color: colors.paper, fontSize: 10, fontWeight: "900", textTransform: "uppercase", paddingHorizontal: 9, paddingVertical: 6, borderRadius: 999, backgroundColor: "rgba(20,13,13,.12)" },
  ...
  coatShelfTile: { width: "48%", minWidth: 132, flexGrow: 1, gap: 7, padding: 10, borderRadius: 18, borderWidth: 1, borderColor: "rgba(20,13,13,.09)", backgroundColor: "rgba(82,38,15,.075)" },
  coatShelfTileLocked: { opacity: 0.78, borderColor: "rgba(245,200,106,.18)" },
  coatShelfBadgeFrame: { alignSelf: "center", width: 78, height: 88, alignItems: "center", justifyContent: "center", borderRadius: 22, backgroundColor: "rgba(82,38,15,.09)", borderWidth: 1, borderColor: "rgba(245,200,106,.18)" },
