...
const compactStyles = StyleSheet.create({
  ...
  activeSoloSection: { position: "relative", gap: 8, marginTop: 96, padding: 13, paddingTop: 38, borderRadius: 24, backgroundColor: "rgba(255,247,232,.078)", borderWidth: 1, borderColor: "rgba(245,200,106,.22)" },
  ...
  coatHeroMarker: { position: "absolute", top: -160, alignSelf: "center", width: 189, height: 189, alignItems: "center", justifyContent: "center", overflow: "visible", zIndex: 7 },
  coatHeroGlowImage: { position: "absolute", width: 213, height: 213, opacity: .62, transform: [{ translateY: 3 }] },
  coatHeroImage: { width: 174, height: 190 },
  coatHeroSeal: { position: "absolute", width: 37, height: 37, right: 2, bottom: 2, zIndex: 4, transform: [{ rotate: "-10deg" }] },
