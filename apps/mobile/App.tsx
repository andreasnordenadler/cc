...
const compactStyles = StyleSheet.create({
  ...
  coatHeroMarker: { width: 230, height: 252, alignItems: "center", justifyContent: "center", overflow: "visible" },
  coatHeroGlowImage: { position: "absolute", width: 262, height: 286, opacity: .72, transform: [{ translateY: 7 }] },
