...
const compactStyles = StyleSheet.create({
  ...
  activeSoloSection: { position: "relative", gap: 8, marginTop: 86, padding: 13, paddingTop: 92, borderRadius: 24, backgroundColor: "rgba(255,247,232,.078)", borderWidth: 1, borderColor: "rgba(245,200,106,.22)" },
  ...
  coatHeroMarker: { position: "absolute", top: -210, alignSelf: "center", width: 236, height: 236, alignItems: "center", justifyContent: "center", overflow: "visible", zIndex: 7 },
  coatHeroGlowImage: { position: "absolute", width: 266, height: 266, opacity: .62, transform: [{ translateY: 3 }] },
  coatHeroImage: { width: 218, height: 238 },
  coatHeroSeal: { position: "absolute", width: 46, height: 46, right: 2, bottom: 2, zIndex: 4, transform: [{ rotate: "-10deg" }] },
  currentQuestHeroTitle: { maxWidth: 286, color: colors.paper, fontSize: 20, lineHeight: 23, fontWeight: "900", letterSpacing: -.55, textAlign: "center", marginTop: -4 },
