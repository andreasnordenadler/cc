...
const compactStyles = StyleSheet.create({
  ...
  activeSoloSection: { position: "relative", alignSelf: "center", width: "94%", gap: 8, marginTop: 78, padding: 13, paddingTop: 78, borderRadius: 24, backgroundColor: "rgba(255,247,232,.078)", borderWidth: 1, borderColor: "rgba(245,200,106,.22)" },
  ...
  coatHeroMarker: { position: "absolute", top: -190, alignSelf: "center", width: 224, height: 224, alignItems: "center", justifyContent: "center", overflow: "visible", zIndex: 7 },
  coatHeroGlowImage: { position: "absolute", width: 252, height: 252, opacity: .62, transform: [{ translateY: 3 }] },
  coatHeroImage: { width: 206, height: 230 },
  coatHeroSeal: { position: "absolute", width: 44, height: 44, right: 2, bottom: 2, zIndex: 4, transform: [{ rotate: "-10deg" }] },
  currentQuestHeroTitle: { maxWidth: 270, color: colors.paper, fontSize: 20, lineHeight: 23, fontWeight: "900", letterSpacing: -.55, textAlign: "center", marginTop: 0 },
