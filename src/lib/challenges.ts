...
export const CHALLENGES: Challenge[] = [
  {
    ...
    flavor: "The official ceremonial rubber stamp for proving you did, in fact, complete a chess game. A low bar, proudly cleared.",
    ...
    badgeIdentity: {
      ...
      heraldry: {
        ...
        meaning: "The stamped check mark represents a finished game accepted as proof; the board marks a quest completed without asking whether the chess was any good.",
