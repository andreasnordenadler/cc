...
export const CHALLENGES: Challenge[] = [
...

  {
    ...
    instruction:
      "Start this beginner side quest, play a real public Lichess or Chess.com game, make your first eight player moves with pawns only, then win anyway. The grown-up pieces can join the party later.",
    openingHint: "The pieces are observing from HR.",
    reward: 80,
    category: "Beginner Quest",
    difficulty: "Easy",
    completionRate: "New quest",
    flavor: "A tiny opening parade where every sandwich is a tempo loss.",
    ...
    rules: [
      "Your first eight moves must all be pawn moves.",
      "Do not move knights, bishops, rooks, queen, or king before your ninth move.",
      "You must win the game.",
      "Standard chess only.",
      "Bullet, blitz, or rapid allowed.",
    ],
    requirement: {
      side: "either",
      result: "win",
