...
export default function DeleteAccountControl() {
  ...
  return (
    <section className="sqc-username-editor-card" aria-labelledby="delete-account-title">
      ...
      <p>Permanently deletes your Side Quest Chess account profile, saved progress, custom Side Quests, and Clerk sign-in. Previously shared public proof links are not revoked, and public game records remain at Lichess or Chess.com. This cannot be undone.</p>
      {expanded ? (
