    ...
    <main className="site-shell">
      ...
      <div className="content-wrap">
        ...
        <section className="grid" aria-label="Verifier summary">
          ...
          <Fact label="Dual-host coverage" value={`${dualHostCount} quests`} copy="The beginner path plus No Castle Club, Queen? Never Heard of Her, and Pawn Storm Maniac can read either Lichess UCI evidence or Chess.com PGN evidence today." />
