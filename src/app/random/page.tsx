...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Random quest machine — Side Quest Chess",
    description: "Spin up a random chess side quest, accept the bad idea, and challenge a friend to do the same cursed thing.",
    url: "/random",
      ...
      <div className="content-wrap">
        ...
        <section className="grid" aria-label="Why random works">
          <article className="stat-card mission-card">
            ...
            <p>The page makes the quest choice feel like a dare, not a settings screen.</p>
          </article>
          <article className="stat-card mission-card">
