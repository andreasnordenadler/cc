    ...
    <main className="privacy-page">
      <article className="privacy-policy privacy-workspace" aria-labelledby="privacy-title">
        ...
        <section id="use">
          ...
          <p>The implementation reviewed for this draft has no advertising feature or targeted-advertising integration. Whether Side Quest Chess should make a broader legal statement about sale or sharing of personal information requires owner/legal confirmation.</p>
        </section>
        ...
        <section id="choices">
          ...
          <ul>
            ...
            <li>You can contact Side Quest Chess about access, correction, or deletion of information associated with your account. The request process and response timeline still require owner confirmation.</li>
          </ul>
        </section>

        <section id="children">
          <h2>Children and international use</h2>
          <p><strong>Launch confirmation required:</strong> the app’s intended minimum user age, parental-consent approach, operating legal entity/controller identity, and primary processing country have not been established in the implementation reviewed for this policy. These facts must be confirmed before final publication or app-store submission.</p>
        </section>

        <section id="changes">
          <h2>Changes to this policy</h2>
          <p>This page should be updated when Side Quest Chess practices change. The final notice process and effective date require owner confirmation.</p>
        </section>
        ...
        <aside className="privacy-notice" role="note" aria-label="Policy status">
          ...
          <p>This is an implementation-based launch draft, not legal advice. The owner confirmations called out above are unresolved and require legal/product review before this text is adopted as the app’s final policy.</p>
        </aside>
      </article>
    </main>
  );
