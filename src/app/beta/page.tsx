...
const betaChecklist = [
  {
    ...
    copy: "Add either chess username. The beginner path, No Castle Club, Queen? Never Heard of Her, and Pawn Storm Maniac now work on Lichess or Chess.com; the rest of the chaos deck is Lichess-backed while Chess.com parity expands.",
    href: "/connect",
    ...
    <main className="site-shell">
      ...
      <div className="content-wrap">
        ...
        <section className="grid" aria-label="Private beta status">
          ...
          <Fact label="Verifier posture" value="6 dual-host quests" copy="All three beginner quests plus No Castle Club, Queen? Never Heard of Her, and Pawn Storm Maniac can produce latest-game receipts from Lichess or Chess.com today." />
        </section>
