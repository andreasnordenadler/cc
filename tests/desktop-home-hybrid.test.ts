...
test("desktop Settings separates profile identity from proof accounts without duplicating the mobile form", () => {
  ...
  assert.equal(css.slice(0, css.indexOf("@media (min-width: 1180px)")).includes(".sqc-mobile-web.desktop-settings .sqc-settings-field-group"), false, "desktop form composition cannot leak below 1180px");
});
