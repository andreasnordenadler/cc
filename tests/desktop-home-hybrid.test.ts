...
test("desktop home keeps account setup visible when a Solo quest is active without a chess username", () => {
  ...
  assert.match(html, /<a class="sqc-blocker" href="\/account"><strong>Connect a chess username<\/strong>/, "the server-rendered responsive anchor preserves the mobile account destination before hydration");
