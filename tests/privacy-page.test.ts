...
test("Privacy Policy keeps its adopted public content and actions", () => {
  ...
  assert.match(html, /<strong>Effective:<\/strong> August 20, 2026/);
  ...
  assert.match(html, /profile, saved progress and proof receipts, custom Side Quests, report, and block data/);
  assert.match(html, /Public proof links already shared use self-contained signed data and may remain accessible after account deletion/);
