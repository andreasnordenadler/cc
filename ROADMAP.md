...
- [ ] Define the smallest next post-parity dual-host authenticated triad-plus-list-plus-coverage Chess.com proof step in `cc/docs/CHESSCOM_POST_PARITY_DUAL_HOST_AUTHENTICATED_TRIAD_PLUS_LIST_PLUS_COVERAGE_NEXT_STEP_2026-04-12.md`.
  - estimate: 1 focused run
