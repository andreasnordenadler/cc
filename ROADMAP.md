...
- [x] Add Community Solo web analytics hooks.
  ...
  - proof: `pnpm lint -- src/components/analytics/community-solo-analytics.tsx src/lib/analytics.ts src/app/challenges/community/page.tsx 'src/app/challenges/community/[id]/page.tsx'`; `pnpm build`.
