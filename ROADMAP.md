...
- [ ] Record one fresh same-run dual-host authenticated-browser triad-plus-list-plus-coverage Chess.com parity check in `cc/docs/CHESSCOM_POST_PARITY_DUAL_HOST_AUTHENTICATED_TRIAD_PLUS_LIST_PLUS_COVERAGE_SMOKE_2026-04-12.md`.
  - estimate: 1 focused run
