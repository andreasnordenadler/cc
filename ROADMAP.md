...
- [ ] Record one fresh dual-host authenticated-browser boundary Chess.com challenge-detail parity check in `cc/docs/CHESSCOM_POST_PARITY_DUAL_HOST_AUTHENTICATED_BOUNDARY_DETAIL_SMOKE_2026-04-12.md`.
  - estimate: 1 focused run
