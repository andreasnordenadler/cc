...
- [ ] Record one fresh same-run dual-host authenticated-browser submission-mutation win-pair Chess.com parity check in `cc/docs/CHESSCOM_POST_PARITY_DUAL_HOST_AUTHENTICATED_SUBMISSION_MUTATION_WIN_PAIR_SMOKE_2026-04-12.md`.
  - estimate: 1 focused run
