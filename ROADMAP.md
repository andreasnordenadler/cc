...
- [ ] 24h SQC website parity sprint: close missing website functionality compared to mobile app while preserving current website look and feel.
  ...
  - 2026-06-10 Multiplayer command-center discovery links slice: closed a small signed-in Multiplayer parity gap versus mobile-v251 by showing the proof-ledger reminder on website `/groupquests` for signed-in users too, and adding direct command-center handoffs to Public Multiplayer discovery, Joined by me, and Hosted by me filters. Proof: `pnpm lint -- src/app/groupquests/page.tsx`; `pnpm build`; committed/pushed `30e5d56`; production deploy `https://cc-ciov64ez6-andreas-nordenadlers-projects.vercel.app` aliased to `https://sidequestchess.com`; live smoke returned 200 for `/groupquests?commandCenterLinksSmoke=20260610` with Multiplayer/Public/Proof rule content and 200 for production/deploy `/groupquests/public?commandCenterLinksSmoke=20260610`; proof doc `docs/SQC_WEB_MULTIPLAYER_COMMAND_CENTER_DISCOVERY_LINKS_2026-06-10.md`.
