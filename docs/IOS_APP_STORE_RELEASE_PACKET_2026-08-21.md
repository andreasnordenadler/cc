...
- Bounded simulator launch smoke: the Release `.app` installed and launched as process `com.sidequestchess.app` on iPhone 17 Pro (`94D16E18-197E-43FD-A133-572FF0A7FBE4`, iOS 26.5) and iPad Pro 13-inch (M5) (`02189F8B-B2ED-49AF-83B5-E630C8059EB1`, iOS 26.5). Each relaunch returned a PID and rendered the signed-out account surface five seconds later. OCR of fresh captures found `Side Quest Chess`, `Sign in to continue.`, `Browse Solo Side Quests`, and `Browse Multiplayer Side Quests` on both devices. The iPhone capture was 1206×2622 and the iPad capture 2064×2752; both PNGs contained alpha and are QA evidence only, not App Store listing assets. Local captures are preserved at `/Users/sam/Projects/sqc-evidence/ios-20260824-eda06968/`: iPhone SHA-256 `d4571ac7415b1fafadca90926a5facd6dea33d179e5a6e56c7aac3cc07fef4c1`; iPad SHA-256 `aeb42181ed5f1d62ec12a700718e1dc511af22eee763513537b591148fd536b8`.
