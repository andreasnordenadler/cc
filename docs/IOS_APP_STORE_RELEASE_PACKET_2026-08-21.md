...
**Source baseline:** `3cdfc0cf90629b3dbd0a57b167ca6700be055159` (`origin/main`, fetched 2026-08-24); this packet update remains under PR review<br>
...
- Simulator registration is now locally available without a destructive reset: `simctl` reports the iOS 26.5 runtime and exact available iPhone/iPad destinations. This clears the earlier local registration blocker only; it does not establish minimum-iOS coverage, signing, TestFlight, or physical-device evidence.
...
- On exact source `3cdfc0cf90629b3dbd0a57b167ca6700be055159`, the Release Simulator build succeeded for scheme `SideQuestChess`, SDK `iphonesimulator26.5`, and iPhone 17 Pro UDID `94D16E18-197E-43FD-A133-572FF0A7FBE4`. The built app identifies as `Side Quest Chess`, bundle `com.sidequestchess.app`, version/build `0.1.349` / `1`, and registers URL schemes `sidequestchess` and `com.sidequestchess.app`; its bundled JavaScript SHA-256 is `3e0b55e076a7dd2063395c238311c8de1a2a63a5123ae59896359dddd42476cb`. Install and process launch passed on iPhone and iPad Simulators. Opening a synthetic `sidequestchess://sso-callback` URL reached the iOS confirmation sheet, proving scheme-handler recognition only; the confirmation was not accepted, so delivery to the app, callback completion, and authentication are not claimed. Runtime logs again exposed unlisted background fetch/remote-notification delegate warnings and the future-required `UIScene` lifecycle warning; reconcile those generated delegate seams before freeze. This is unsigned Simulator evidence only. No signed archive, TestFlight build, or physical-device evidence exists.
...
| Generated native audit | Partial | Clean prebuild, CocoaPods, generated settings/privacy inventory, and Release Simulator build passed on exact source; exact signed archive inspection remains blocked |
...
11. Reconcile the generated iOS delegate warnings before freeze: determine whether background fetch or remote-notification behavior is actually intended before adding any background mode, and verify Expo/React Native's current `UIScene` lifecycle support path rather than mutating generated native files ad hoc.
...
- `pnpm test`: PASS — 811 tests, 0 failures, 0 skipped/todo.
...
- Current local native receipt on exact `origin/main` source `3cdfc0cf90629b3dbd0a57b167ca6700be055159`: Xcode 26.6 and iOS 26.5 SDK selected; CocoaPods 1.17.0; `pod install` PASS with 85 dependencies/84 pods; Release Simulator build succeeded for `SideQuestChess` on iPhone 17 Pro UDID `94D16E18-197E-43FD-A133-572FF0A7FBE4`, iOS 26.5; app identity is `Side Quest Chess`, `com.sidequestchess.app`, `0.1.349` / `1`; bundled JavaScript SHA-256 is `3e0b55e076a7dd2063395c238311c8de1a2a63a5123ae59896359dddd42476cb`. iPhone and iPad install and launch PASS: iPhone 17 Pro Max, iOS 26.5, UDID `3511296F-A745-4B56-8913-EA454DA8420E`, produced a `1320×2868` capture (SHA-256 `9e44e39fc3408f9fc0e505c37054becdb79ee6f3c40c1ce1045ba1b3bba741d5`); iPad Pro 13-inch (M5), iOS 26.5, UDID `02189F8B-B2ED-49AF-83B5-E630C8059EB1`, produced a `2064×2752` capture (SHA-256 `f439b1c5e4f318ef9ea526f45b35ceb1999379092cc5a9e417d92c56e2cd988e`). The captures were not visually accepted in this headless run and OCR did not establish the complete rendered state, so signed-out surface acceptance and iPad responsive layout remain NOT PASSED. A synthetic callback opened the iOS app-confirmation sheet, proving scheme-handler recognition only; the confirmation was not accepted, so delivery to the app, callback completion, and authentication remain unverified. Runtime logs recorded the future-required `UIScene` lifecycle warning plus background fetch/remote-notification delegate warnings.
- Runtime registration, native compilation, bundled Simulator install, and process launch are now PASSED locally. Minimum-iOS coverage, iPad responsive layout, complete callback/authentication, Swift/XCTest `.xcresult`, archive, Apple signing, TestFlight, and physical-device smoke remain NOT PASSED. No signed archive, TestFlight build, or physical-device evidence exists; the separate Apple legal identity, account, signing, and approval gates remain blocking.
