...
- Exact-current `pnpm test`: PASS — 814 tests, 0 failures, 0 skipped/todo.
- The prior reconciled branch's `pnpm build` passed, but the exact-current baseline was not rebuilt in this bounded iOS run; do not treat the prior web receipt as exact-current evidence.
