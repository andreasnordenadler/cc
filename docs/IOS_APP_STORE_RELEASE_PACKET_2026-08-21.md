...
- `pnpm test`: PASS — 795 tests, 0 failures, 0 skipped/todo on the final branch (794 on the unmodified current-main baseline plus the new current-candidate packet contract).
...
- Current local native receipt at `a161663a041f91306f4970b735525c403f3d48d1`: Xcode 26.6 with iOS 26.5 SDK/runtime selected; CocoaPods 1.17.0; `pod install` PASS with 85 dependencies/84 pods; aggregate generated privacy manifest inspected; Debug Simulator builds PASS on exact iPhone and 13-inch iPad destinations; standalone Release Simulator build PASS with bundled JavaScript SHA-256 `45b5d4ed23beaf115dafd4a1867b2e6fd4aa9ad0a483a50c22a104d1142d32fb`; iPhone 17 Pro Max install, launch, and `sidequestchess://sso-callback` OS handoff PASS. No signed archive, IPA, `.xcresult`, provider-auth completion, screenshots, TestFlight build, or physical-device proof was produced.
