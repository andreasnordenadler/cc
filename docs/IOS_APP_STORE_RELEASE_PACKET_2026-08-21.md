...
| Privacy policy safety data | Live readback passed; reconciliation blocked | Signed-out production policy discloses report/block and deletion behavior; provider, retention, label and exact-IPA reconciliation remains required |
