...
- The unsigned Release Simulator app installed and launched on iPhone 17 Pro (`94D16E18-197E-43FD-A133-572FF0A7FBE4`), iPad mini (A17 Pro) (`2DE5C1CA-35C5-4792-A4FF-F3209AA06986`), and iPad Pro 13-inch (M5) (`02189F8B-B2ED-49AF-83B5-E630C8059EB1`), all on iOS 26.5. Fresh signed-out captures were `1206×2622`, `1488×2266`, and `2064×2752`; OCR found the expected Side Quest Chess identity and sign-in/browse controls. These captures are local launch evidence, not approved App Store screenshots or responsive interaction acceptance.
