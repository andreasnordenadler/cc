...
| Account deletion / retained safety identifiers | Blocked | Retained report and block identifiers are a source-level account-deletion blocker: purge or anonymize references held in other users' metadata, or document a legally required retention basis, scope, duration, access controls, and user disclosure |
