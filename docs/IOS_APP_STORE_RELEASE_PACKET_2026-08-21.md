...
- Historical full-suite receipt on mobile-input baseline `3cf61fb1d5233a8899d5dfcd3a6caea4c2a8dc4a`: PASS — 811 tests, 0 failures, 0 skipped/todo. It is not independently auditable and was not rerun for this packet reconciliation. The documentation contract is rerun on the current packet tree. Historical mobile TypeScript and Expo Doctor passes likewise remain observations rather than current-candidate receipts.
