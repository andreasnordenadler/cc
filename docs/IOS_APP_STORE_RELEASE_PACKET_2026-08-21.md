...
**Source baseline:** `66213d472fd8ff4bce2a6d51022c19878d27b5d4` (`origin/main`, fetched and reconciled 2026-08-23); branch source-preparation changes remain under PR review<br>
**Branch reconciliation point:** `c058359f7e721f741db42e6f4390a4f4663eb94d`; later working-tree changes and this packet are not a frozen release candidate<br>
**Native build receipt baseline:** `b98ad94c3bc00fca8377cf371882660d965692bc`; the reconciled merge left `apps/mobile` byte-identical to that baseline, but the unsigned Simulator receipt below is not an exact-HEAD build receipt<br>
...
- Public-proof fixture TDD receipt: RED proved that the production decoder accepted any unsigned `preview-<challengeId>` route and rendered fixed sample data; GREEN removes that bypass and requires the normal signed-token format. The targeted test and full 797-test suite pass.
- `git diff --check`: PASS.
