...
**Current source:** `eda0696886b9eabaa20b999eacb296be9da09b8d` (`origin/main`, fetched 2026-08-24); the iOS preparation lane was merged in `5a5cbd45`
...
- Exact-current-source native receipt (2026-08-24): the build ran from clean branch head `af0ab4b8dd6623c52c2c36f8f266ef78b2929e07`; its mobile source tree `ea79dc32b07345b5bd676041a421ebb4c372203b` was identical to fetched `origin/main` `eda0696886b9eabaa20b999eacb296be9da09b8d`. Frozen dependency installation passed, Expo Doctor passed 18/18, iOS prebuild passed, and CocoaPods 1.17.0 installed 85 dependencies/84 pods. The generated workspace is `SideQuestChess.xcworkspace`, scheme `SideQuestChess`, bundle ID `com.sidequestchess.app`, version/build `0.1.349` / `1`, deployment target iOS 15.1, SDK iOS 26.5, device family `1,2`, and configuration Release for the launch artifact. Retained provenance and command output begin at `/Users/sam/Projects/sqc-evidence/ios-20260824-eda06968/logs/00-provenance.txt`; the adjacent numbered logs preserve install, prebuild, CocoaPods, Xcode discovery, Debug/Release build, install, launch and OCR receipts.
- Debug simulator build on iPhone 17 Pro destination `94D16E18-197E-43FD-A133-572FF0A7FBE4`: **BUILD SUCCEEDED** with signing disabled. Release simulator build on the same exact destination: **BUILD SUCCEEDED**, including the bundled `main.jsbundle` and Xcode store-validation phase. The Release artifact receipt records executable SHA-256 `25c5a5f8045d0ce984aa258add5f858321f2ab9bbdc90ca12612ee7620677ef5`, `main.jsbundle` SHA-256 `6ef1c0422b2877b5cdd8f9109e8d4857f7a981ad8bbfe47f9013f6188c20f155`, Info.plist SHA-256 `810f7b17e38d2dbd669314204b1d2561ac24e329bdd3abbfddca5776bac29670`, and aggregate PrivacyInfo.xcprivacy SHA-256 `58b13a0ea48613968b376ed43fe0a2abae5c34922be1a657e8fee4961b4a81c9`. The build emitted expected React Native/Hermes JavaScript global warnings and the recurring Hermes script-phase warning; no compiler error occurred.
- Bounded simulator launch smoke: the retained unsigned Release `.app` was packaged as `artifacts/SideQuestChess-0.1.349-1-unsigned-simulator.zip` (SHA-256 `afaf67b0a16144267460527739c94977465ba2acaeba4e60d70c29b3024a65c3`), re-expanded, hash-checked, installed, and launched as process `com.sidequestchess.app` on iPhone 17 Pro (`94D16E18-197E-43FD-A133-572FF0A7FBE4`, iOS 26.5) and iPad Pro 13-inch (M5) (`02189F8B-B2ED-49AF-83B5-E630C8059EB1`, iOS 26.5). Before each launch, executable, `main.jsbundle`, Info.plist, and PrivacyInfo.xcprivacy hashes were read back from the exact installed simulator container and matched the retained Release artifact. Exact commands and installed-artifact linkage are retained in `/Users/sam/Projects/sqc-evidence/ios-20260824-eda06968/logs/19-install-launch-verification.log`. Each launch returned a PID and rendered the signed-out account surface five seconds later. OCR of the linked fresh captures found `Side Quest Chess`, `Sign in to continue.`, `Browse Solo Side Quests`, and `Browse Multiplayer Side Quests` on both devices. The iPhone capture was 1206×2622 and the iPad capture 2064×2752; both PNGs contained alpha and are QA evidence only, not App Store listing assets. Local captures are preserved at `/Users/sam/Projects/sqc-evidence/ios-20260824-eda06968/`: iPhone SHA-256 `10d4fdcb7fc3021b35bd728b52222a48e0713e9549d8ad370062175274571720`; iPad SHA-256 `518699697aa525b16299c3f813e99a2008d2d8dfaa329116d236294b0e23d894`.
