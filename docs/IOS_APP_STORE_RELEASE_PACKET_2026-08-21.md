...
- Exact-current-source native receipt (2026-08-24): from clean `origin/main` commit `eda0696886b9eabaa20b999eacb296be9da09b8d`, frozen dependency installation passed, Expo Doctor passed 18/18, iOS prebuild passed, and CocoaPods 1.17.0 installed 85 dependencies/84 pods. The generated workspace is `SideQuestChess.xcworkspace`, scheme `SideQuestChess`, bundle ID `com.sidequestchess.app`, version/build `0.1.349` / `1`, deployment target iOS 15.1, SDK iOS 26.5, device family `1,2`, and configuration Release for the launch artifact.
- Debug simulator build on iPhone 17 Pro destination `94D16E18-197E-43FD-A133-572FF0A7FBE4`: **BUILD SUCCEEDED** with signing disabled. Release simulator build on the same exact destination: **BUILD SUCCEEDED**, including the bundled `main.jsbundle` and Xcode store-validation phase. The build emitted expected React Native/Hermes JavaScript global warnings and the recurring Hermes script-phase warning; no compiler error occurred.
- Bounded simulator launch smoke: the Release `.app` installed and launched as process `com.sidequestchess.app` on iPhone 17 Pro (`94D16E18-197E-43FD-A133-572FF0A7FBE4`, iOS 26.5) and iPad Pro 13-inch (M5) (`02189F8B-B2ED-49AF-83B5-E630C8059EB1`, iOS 26.5). Both processes remained alive when checked. OCR of fresh captures found `Side Quest Chess`, `Sign in to continue.`, `Browse Solo Side Quests`, and `Browse Multiplayer Side Quests` on both devices. The iPhone capture was 1206×2622 and the iPad capture 2064×2752; both PNGs contained alpha and are QA evidence only, not App Store listing assets. Local captures are preserved at `/Users/sam/Projects/sqc-evidence/ios-20260824-eda06968/`: iPhone SHA-256 `15bd407d82de53fb84480e009f0051268de458beb3da8cff04092d194f4586b6`; iPad SHA-256 `066640036f06e107eecd8f5b9acbe8e9c2f259fdaa6c2fc0ab2120fdd49e2b4a`.
- Simulator logs contained a future `UIScene` lifecycle warning plus CoreUI theme-store and launch-measurement simulator faults. No process crash was observed, but these warnings need exact archive/device review and are not waived by a live process.
