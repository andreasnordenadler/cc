...
## Follow-up re-check at 2026-04-10 13:44 Europe/Stockholm

The Clerk production keys remain test/dev and `/account` remains blocked to live users.
...
## Follow-up re-check at 2026-04-10 17:00 Europe/Stockholm

The Clerk production keys are still test/dev, and the live `/account` route still rewrites to 404.
