...
Candidate: `0.1.348 (349)` for Internal testing
...
| Current-candidate store screenshots | No curated listing set exists for code 349 | **Missing.** Earlier responsive engineering captures prove the corrected layout across the required Android matrix, but they are not a listing-ready 9:16 set and are not Play-delivered-build evidence. |
...
Capture from the Play-delivered code-349 install after tester access and signer verification. Use a non-sensitive disposable account, remove notifications and personal identifiers, and keep the system bars/rendering consistent.
...
For every final image, verify: exact dimensions/aspect ratio, no clipping or overlap, no keyboard unless intentional, no debug UI, no stale version copy, no private account data, and correspondence with code 349 behavior. Do not use Carl's regression screenshot in the store listing.

## Release alignment and blockers

- Frozen AAB: `side-quest-chess-android-v348-code349.aab`
- AAB SHA-256: `c416609b1240114612f888c8a0fff205fafe0a8821ee4065cb833b395f7cbf71`
- Immutable EAS source: `4925cd13b6a39a8be1658ac46c0bea396260dbd2`
- EAS build: `dd277377-25fb-4923-a1ec-10b930c25563` (`production` / `STORE`)
- Committed app identity: `0.1.348` / code `348`; EAS production auto-increment reserved artifact code `349`
...
3. Play App Signing, tester access, and the code-349 Internal testing install remain unverified owner-gated Console steps.
