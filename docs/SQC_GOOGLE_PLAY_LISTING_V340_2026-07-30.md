...
> **SUPERSEDED OPERATIONS — legacy listing copy and asset evidence only.** The code-347 candidate and screenshot instructions are superseded; the instructions below are historical evidence. Do not use them for upload, tester, screenshot, or Console work. The code-348 internal testing plan controls current candidate operations: `docs/SQC_GOOGLE_PLAY_INTERNAL_TEST_PLAN_V348_2026-08-05.md`.
