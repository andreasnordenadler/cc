# Google Play Internal testing plan — Android code 347
...
- Candidate: `0.1.346` / Android version code `347`.
- AAB: `apps/mobile/artifacts/android/mobile-v346-code347/side-quest-chess-android-v346-code347.aab`.
...
4. Create a new Internal testing release and upload only the exact code-347 AAB. Do not upload an APK or a superseded bundle.
5. Require Play's parsed identity to show package `com.sidequestchess.app`, version name `0.1.346`, and version code `347`. Stop on any mismatch or signing warning.
...
10. Confirm the installer package is `com.android.vending`, installed version is `0.1.346 (347)`, and the installed signer matches the recorded Play app signing certificate.
...
- Play delivered code 347 through Internal testing;
