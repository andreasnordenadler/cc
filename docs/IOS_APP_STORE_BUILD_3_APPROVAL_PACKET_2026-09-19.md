...
- Fresh frozen-candidate gates (2026-09-20): full suite **2,271 passing**; root lint and production web build passed; mobile TypeScript passed; Expo Doctor **18/18**. The isolated candidate checkout was clean before and after the gates. The frozen build-3 `apps/mobile` tree remains byte-identical to current `origin/main`; this does not imply that later web/analytics source is part of the signed IPA.
