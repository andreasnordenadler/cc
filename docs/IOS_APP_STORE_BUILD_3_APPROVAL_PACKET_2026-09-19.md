...
- Fresh frozen-candidate gates (2026-09-19): full suite **2,294 passing**; root lint and production web build passed; mobile TypeScript and Expo Doctor (**18/18**) passed. The isolated candidate checkout was clean before and after these gates.
