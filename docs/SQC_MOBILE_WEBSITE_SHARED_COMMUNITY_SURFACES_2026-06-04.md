...
- **Shared backend/model:** avoid mobile-only or website-only capability gaps unless explicitly approved.
...
- Neither website nor mobile lags behind the other on public/community capabilities.
